...
3、域名解析（DNS）得到相应域名的IP地址
4、浏览器向服务器发起tcp连接，与浏览器建立tcp三次握手
5、握手成功，浏览器向这个IP服务器发送http请求，请求数据包
   // 如果服务器的永久重定向响应，浏览器跟踪重定向地址，然后再根据新地址重新从1开始加载过程
...
## 输入URL到页面显示的前端体系知识 https://juejin.cn/post/6994066112203718686 

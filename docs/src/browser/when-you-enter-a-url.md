...
这点可以参考下本题的原始出处：http://fex.baidu.com/blog/2014/05/what-happen/

## 为什么说知识体系如此重要？（作者述）

为什么说知识体系如此重要呢？这里举几个例子

### 设有被问到这样一道题目（随意想到的一个）：如何理解getComputedStyle
...
就这个API来说，上述的回答已经比较全面了。但是，其实它是可以继续延伸的。
...
### 再举一个例子：visibility: hidden和display: none的区别
...
**直到后来，在将浏览器渲染原理、JS运行机制、JS引擎解析流程梳理一遍后，感觉就跟打通了任督二脉一样**，有了一个整体的架构，以前的知识点都连贯起来了。梳理出了一个知识体系，以后就算再学新的知识，也会尽量往这个体系上靠拢，环环相扣，更容易理解，也更不容易遗忘
...
`tcp将http长报文划分为短报文`，通过`三次握手与服务端建立连接`，进行可靠传输
...
而且`在http1.0中往往一个资源下载就需要对应一个tcp/ip请求`
...
![1](/assets/images/when-you-enter-a-url1.webp)
...
![2](/assets/images/when-you-enter-a-url2.webp)
...
另外，由于**在同域名的资源请求时**，`浏览器会默认带上本地的cookie`，针对这种情况，在某些场景下是需要优化的。
...
![3](/assets/images/when-you-enter-a-url3.webp)
...
![4](/assets/images/when-you-enter-a-url4.webp)
...
![5](/assets/images/when-you-enter-a-url5.webp)
...
![6](/assets/images/when-you-enter-a-url6.webp)
...
![7](/assets/images/when-you-enter-a-url7.webp)
...
![8](/assets/images/when-you-enter-a-url8.webp)
...
![9](/assets/images/when-you-enter-a-url9.webp)

### 渲染

有了render树，接下来就是开始渲染，基本流程如下：

![10](/assets/images/when-you-enter-a-url10.webp)
...
![11](/assets/images/when-you-enter-a-url11.webp)
![12](/assets/images/when-you-enter-a-url12.webp)
...
这里不一一展开，更多请参考：http://bbs.csdn.net/topics/340204423
...
![13](/assets/images/when-you-enter-a-url13.webp)
...
![14](/assets/images/when-you-enter-a-url14.webp)
...
```
![15](/assets/images/when-you-enter-a-url15.webp)
...
更多参考：深入理解JavaScript系列（13）：This? Yes,this! https://www.cnblogs.com/TomXu/archive/2012/01/17/2310479.html
...
可以参考：ajax跨域，这应该是最全的解决方案了

**可以提到web安全**

譬如浏览器在解析HTML时，有XSSAuditor，可以延伸到web安全相关领域

可以参考：AJAX请求真的不安全么？谈谈Web安全与AJAX的关系。
